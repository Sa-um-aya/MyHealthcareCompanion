...
symptoms_dict = {
    ...
    'fluid_overload_1': 117, 'blood_in_sputum': 118,
    'prominent_veins_on_calf': 119, 'palpitations': 120,
    'painful_walking': 121, 'pus_filled_pimples': 122,
...
diseases_list = {
    ...
    13: 'Dimorphic hemorrhoids (piles)', 18: 'Heart attack',
...
# ================= SHAP =================
background = np.zeros((1, len(symptoms_dict)))
explainer = shap.KernelExplainer(svc.predict, background)
...
def predict():
    ...
    if not symptoms:
        return render_template("index.html", message="Enter valid symptoms")
    ...
    predicted_disease = diseases_list[pred_index]

    shap_values = explainer.shap_values(input_vector)
    shap_dict = {k: shap_values[0][i] for k, i in symptoms_dict.items()}
